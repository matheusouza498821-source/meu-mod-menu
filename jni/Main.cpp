...
jobjectArray GetFeatureList(JNIEnv *env, jobject context) {
    ...
    const char *features[] = {
            ...
            OBFUSCATE("2_Toggle_Aimbot 100%"),
            OBFUSCATE 3_Toggle_ESP LINES
...
void Changes(JNIEnv *env, jclass clazz, jobject obj, jint featNum, jstring featName, jint value, jlong Lvalue, jboolean boolean, jstring text) {
    ...
    switch (featNum) {
        ...
        case 1: 
            if (boolean) {
            PATCH(targetLibName, "0x01766C55", "1E FF 2F E1");
        }
        break;

        case 2:
            if (boolean) {
            PATCH(targetLibName, "0x174DF4D", "00 00 A0 E3");
        }
        break;
        ...
        case 3:
            if (boolean) {
            PATCH(targetLibName, "0x28F7955", "00 20 70 47");
        }
        break;
